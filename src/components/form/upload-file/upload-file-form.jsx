...
export default function UploadFileForm() {
  ...
  return (
    <div className="mt-6">
      ...
      {files.map((e) => {
        return (
          <div key={e.id} className="bg-gray-50  rounded-lg px-4 py-1 mt-2">
            {e.name}
          </div>
        );
      })}
      ...
      <button
        className="flex justify-center bg-yellow rounded-md py-1 mt-4 cursor-pointer hover:text-white w-full"
        onClick={async () => {
