...
export default function ListProduk({setIsModalOpen, setDetailOtr}) {
  ...
  useEffect(()=>{
    (async () => {
      const response = await fetch("/api/otr/produk?" + new URLSearchParams({ search: searchParams.get("search_query_produk") === null ? "" : searchParams.get("search_query_produk") }))
