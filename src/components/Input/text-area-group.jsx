...
function TextAreaGroup({ id, name, label, placeholder, value, type = "text", register, validation, errors, ...props }) {
  return (
    <>
      {label && (
      ...
      <div className="relative mt-1 rounded-md shadow-sm cursor-pointer">
        <textarea
          ...
          className={`block w-full h-full rounded-md border-0 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm  ${
