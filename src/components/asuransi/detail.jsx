...
export default function AsuransiDetailPage({ asuransi }) {
  ...
  const [alasan, setAlasan] = useState(
    asuransi.status == "P" ? asuransi.alasan_pending : asuransi.status == "T" ? asuransi.alasan_tdk_berminat : ""
  );
  ...
  useEffect(() => {
    return setFormData({
      ...formData,
      province: alamatKirim.province.code,
      city: alamatKirim.city.code,
      subdistrict: alamatKirim.subdistrict.code,
    });
  ...
  if (alasanPending.length < 1 || alasanTdkBerminat.length < 1) {
    return "Loading...";
  }
  ...
  return (
    <div className=" space-y-6 sm:mt-5 sm:space-y-5">
      {message != "" && (
        <div className="bg-green-500 rounded-lg mb-4 text-white flex justify-center text-lg p-4">{message}</div>
      )}
      {formData.jenis_source == "E" && (
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
          ...
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input
              ...
              name="id_transaksi"
              id="id_transaksi"
              defaultValue={formData.id_transaksi}
              disabled
            />
          </div>
        </div>
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        <label htmlFor="nik" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
          NIK
        </label>
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            name="nama"
            id=""
            defaultValue={formData.nama_customer}
            disabled
          />
        </div>
      </div>
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <select
            required
            defaultValue={formData.jenis_asuransi}
            disabled={true}
            className="max-w-lg pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none z-1 focus:outline-none focus:ring-0 focus:border-black border-gray-200 cursor-pointer"
          >
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            name="nm_mtr"
            id=""
            defaultValue={formData.nama_motor}
            disabled
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            name="nm_mtr"
            id=""
            defaultValue={formData.tgl_faktur.slice(0, 10)}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        <label htmlFor="no_telp" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
          Nomor Telepon
        </label>
        <div className="mt-1 sm:mt-0 sm:col-span-2 relative">
          <a href={"tel:" + formData.no_telepon}>
            <PhoneIcon
              className="w-6 h-5 absolute left-[475px]  cursor-pointer top-2 hover:text-yellow"
              aria-hidden="true"
            />
          </a>
          <input
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        <label htmlFor="no_telp2" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
          Nomor Telepon 2
        </label>
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            name="no_telp2"
            id=""
            defaultValue={formData.no_telp2}
            onChange={(e) => {
              setFormData({ ...formData, no_telp2: e.target.value });
            }}
          />
        </div>
      </div>
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          ...
          >
            <option value="" disabled>
              Please Select Alasan
            </option>
            {formData.status == "P" &&
              alasanPending.map((item, i) => {
                return (
      ...
      {asuransi.jenis_source == "E" && (
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
          <label htmlFor="status-bayar" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
            Status Bayar
          </label>
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <select
              required
              defaultValue={formData.status_bayar}
      ...
      {asuransi.jenis_source == "E" && (
        <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
          <label htmlFor="tgl-bayar" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
            Tanggal Bayar
          </label>
          <div className="mt-1 sm:mt-0 sm:col-span-2">
            <input
              ...
              name="tgl_bayar"
              id="tgl-bayar"
              disabled={formData.status == "O" ? false : true}
              value={formData.tgl_bayar != null ? formData.tgl_bayar.slice(0, 10) : ""}
              defaultValue={formData.tgl_bayar != null ? formData.tgl_bayar.slice(0, 10) : ""}
              onChange={(e) => {
                setFormData({ ...formData, tgl_bayar: e.target.value });
              }}
            />
          </div>
        </div>
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            id=""
            disabled={true}
            defaultValue={alamatKirim.subdistrict.name}
            value={alamatKirim.subdistrict.name}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        <label htmlFor="kota" className="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2">
          Kota
        </label>
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            id="kota"
            disabled={true}
            defaultValue={alamatKirim.city.name}
            value={alamatKirim.city.name}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2 relative">
          ...
          <input
            ...
            name="province"
            id="province"
            defaultValue={alamatKirim.province.name}
            value={alamatKirim.province.name}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <select
            required
            value={formData.jns_brg != null ? formData.jns_brg : ""}
            onChange={(e) => {
          ...
          >
            ...
            {produks.length > 0 &&
              produks.map((item, i) => {
                return (
                  <option key={i} value={item.kd_produk}>
                    {item.nm_produk}
                  </option>
                );
              })}
