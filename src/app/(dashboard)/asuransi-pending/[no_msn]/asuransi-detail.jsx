      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2 relative">
          ...
          <input
            ...
            name="no_telepon"
            id=""
            defaultValue={formData.no_telepon}
            disabled
          />
        </div>
      </div>
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          ...
          >
            ...
            {formData.status == "P" &&
              alasan_pending_list.map((item, i) => {
                return (
            ...
            {formData.status == "T" &&
              alasan_tdk_berminat_list.map((item, i) => {
                return (
                  <option key={i} value={item.key}>
                    {item.value}
                  </option>
      ...
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            id=""
            disabled={true}
            defaultValue={alamatKirim.kecamatan}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <input
            ...
            id=""
            disabled={true}
            defaultValue={alamatKirim.kelurahan}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2 relative">
          ...
          <input
            ...
            name="kodepos"
            id=""
            defaultValue={alamatKirim.kodepos}
          />
        </div>
      </div>
      <div className="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        ...
        <div className="mt-1 sm:mt-0 sm:col-span-2">
          <select
            required
            defaultValue={formData.jns_brg != null ? formData.jns_brg : ""}
            onChange={(e) => {
