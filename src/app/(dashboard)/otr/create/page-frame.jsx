            ...
            <form className="w-full" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="-mx-3 mb-6 w-full grid grid-cols-12">
                    ...
                    <div className="w-full px-3 mb-5 align-middle col-span-6 grid grid-cols-12 relative">
                        {createFrom == "motorprice" && <ModalProduk setDetailOtr={setDetailOtr} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen}/>}
                        {createFrom == "otrna" && <OtrNa setDetailOtr={setDetailOtr} isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen}/>}
